...
function Home() {
    ...
    return (
        <>
            {/* First section */}
            <section className='sectionHome bg-black h-screen'>
                <Nav></Nav>
            ...
            {/* Second section */}
            <section className='sectionHome bg-black h-screen flex flex-col items-center gap-6 lg:flex-row'>
                ...
                <div className='w-11/12 text-start -mt-28 z-10 lg:text-start lg:pr-4 lg:absolute lg:z-10 lg:right-5 lg:w-2/4 xl:pr-12 xl:mt-32'>
                    <h2 className='text-white font-bold text-[2.75rem] pb-6 lg:text-6xl'>Escucha la diferencia</h2>
                    <p className='text-[#D5D5D5] text-xl'>El estándar Full-Fidelity™ patentado por <span className='text-white font-semibold'>Digital</span> ofrece audio sin precedentes y verdaderamente sin pérdidas, exactamente como se pretendía escuchar. Rodéate de un sonido impecable y redescubre tu música favorita en un cómodo dispositivo todo en uno, supraaural y completamente inalámbrico.</p>
                </div>
            </section>
            {/* Third section */}
            <section className='sectionHome bg-black flex flex-col items-center gap-6 pb-24 pt-32 lg:flex-row-reverse lg:pt-0 xl:pb-0'>
                <div className='w-full flex items-center justify-center sm:w-3/4 lg:w-2/4 lg:relative lg:-ml-36'>
            ...
            {/* Fourth section */}
            <section className='sectionHome bg-black flex flex-col items-center gap-6 pb-24 pt-32 lg:flex-row lg:pt-6'>
                <div className='w-full flex items-center justify-center sm:w-3/4 lg:w-2/4 lg:relative'>
                ...
                <div className='w-11/12 text-start -mt-28 z-10 sm:w-11/12 lg:text-start lg:w-3/5 lg:pl-16 lg:absolute lg:z-10 lg:right-12 lg:mt-10 xl:pl-24 xl:w-[55%]'>
                    ...
                    <div className='flex flex-col gap-8 text-white pr-4'>
                        <div className='flex gap-2'>
                            <BsCartCheck size={40} color='white' className='w-2/12'></BsCartCheck>
                            <div className='w-4/5'>
                                <h4 className='font-semibold text-xl xl:text-2xl'>Garanía</h4>
                        ...
                        <div className='flex gap-2'>
                            ...
                            <div className='w-4/5'>
                                <h4 className='font-semibold text-xl xl:text-2xl'>Envío gratis</h4>
                        ...
                        <div className='flex gap-2'>
                            ...
                            <div className='w-4/5'>
                                <h4 className='font-semibold text-xl xl:text-2xl'>Compra ahora, paga luego</h4>
                        ...
                        <div className='flex gap-2'>
                            ...
                            <div className='w-4/5'>
                                <h4 className='font-semibold text-xl xl:text-2xl'>Métodos de pago</h4>
                    ...
                    <div className='m-auto w-11/12 pt-12'>
