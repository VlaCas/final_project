...
function Register() {
	...
	const { signup, isAuthenticated, showPopupMessage } = useAuth(); 
				...
				<div className='flex flex-col gap-10 sm:w-[55%] md:w-full lg:w-4/5 xl:w-4/6'>
					...
					<form className='flex flex-col gap-6 text-lg font-medium' onSubmit={onSubmit}>
						...
						<div className='w-full'>
							<button type='submit' className='button-register bg-[#8A3BBF]' onClick={() => {setClickSubmit((current) => !current)}}><p>Crear Cuenta</p></button>
						</div>
						<div>
